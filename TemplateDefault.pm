...
sub page_header {
    ...
    my $html_title = $results->results
        ...
        # don't display logo - MSR:22/03/13
...
sub show_form {
    ...
    my $advanced_form = $q->param('brief')
        ...
        $limit_select
EOF
# MSR 03062021 no display of $date_ranges_select
    ...
    <form method="get" action="$form" enctype="application/x-www-form-urlencoded" class="form">
        ...
        $hidden
        <input value="Rechercher !" type="submit" name="submit"/><br>
...
sub get_meta_name_limits {
 ...
 # translation to french MSR - 22/03/13
 #    'Limit search to:',
